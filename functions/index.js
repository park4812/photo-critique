...
[채점 기준 - 반드시 이 기준에 따라 엄격하게 채점하세요]
9.0~10.0: 프로 사진작가 수준, 전시/출판 가능한 탁월한 퀄리티. 매우 드묾.
7.5~8.9: 상급 아마추어~준프로 수준, 기술과 표현이 우수하나 완벽하지는 않음.
6.0~7.4: 중급 수준, 기본기는 있으나 개선 여지가 명확함.
4.0~5.9: 초급 수준, 기술적 부족이 눈에 띔.
0~3.9: 심각한 기술적 결함.
대부분의 일반 사진은 5.0~7.5 범위에 있어야 합니다. 8.0 이상은 확실한 근거가 있을 때만 부여하세요.
관대하게 채점하지 마세요. 냉정하고 객관적으로 평가하세요.
